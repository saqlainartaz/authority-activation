...
const sections = [['account', 'Account', 'Name, headline, password, log out'], ['preferences', 'Preferences', 'Appearance and time zone'], ['integrations', 'Integrations', 'Connect social accounts'], ['usage', 'Usage', 'Generations left this month'], ['data', 'Data', 'Export and manage your data']];
